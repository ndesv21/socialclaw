...
- Use `instagram_business` only for professional or business accounts linked to a Facebook Page.
...
- Supports text and native image or video upload.
- Supports one video or up to twenty images per post.

## LinkedIn Page

- Use `linkedin_page` for organization or page targets.
...
- Product, collection, and idea surfaces are capability-gated or beta. Check account capabilities and actions before promising them.
